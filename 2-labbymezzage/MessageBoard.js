...
var MessageBoard = {
    ...
    time.appendChild(document.createTextNode(MessageBoard.messages[messageID].getDateText()));
        ...
        imageClose.setAttribute("src", "red.jpg");
        ...
        imageClock.setAttribute("src", "clock1.png");
        ...
        // Anropar funktionen showTime som ska visa tiden ifall man klickar på tid knappen
